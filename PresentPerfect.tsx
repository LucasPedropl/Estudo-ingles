  ...
  return (
    <div className="space-y-8 pb-12">
      <header>
        ...
        <p className="text-slate-600">The verb tense that connects the past to the present. Focuses on the result or experience, not on "when" it happened.</p>
      </header>

      {/* The Formula */}
      <section className="bg-gradient-to-r from-teal-600 to-emerald-600 rounded-2xl p-8 text-white shadow-lg">
        <h3 className="text-2xl font-bold mb-6 text-center">The Magic Formula</h3>
        <div className="flex flex-col md:flex-row items-center justify-center gap-4 text-lg md:text-xl font-mono bg-white/10 p-6 rounded-xl border border-white/20">
          <div className="flex flex-col items-center">
            <span className="text-sm text-teal-200 font-sans mb-1">Subject</span>
            <strong>Subject</strong>
          </div>
          <span className="text-2xl">+</span>
          <div className="flex flex-col items-center">
            <span className="text-sm text-teal-200 font-sans mb-1">Auxiliary</span>
            <strong>Have / Has</strong>
          </div>
          <span className="text-2xl">+</span>
          <div className="flex flex-col items-center">
            <span className="text-sm text-teal-200 font-sans mb-1">Main Verb</span>
      ...
      <div className="grid md:grid-cols-3 gap-6">
        <div className="bg-white p-6 rounded-2xl shadow-md border-t-4 border-teal-500">
          ...
          <h4 className="font-bold text-slate-800 mb-2">Life Experience</h4>
          <p className="text-sm text-slate-600 mb-3">Things you have done (or never done) in your life. The time does not matter.</p>
        ...
        <div className="bg-white p-6 rounded-2xl shadow-md border-t-4 border-blue-500">
          ...
          <h4 className="font-bold text-slate-800 mb-2">Unfinished Time</h4>
          <p className="text-sm text-slate-600 mb-3">Actions that started in the past and continue until today.</p>
        ...
        <div className="bg-white p-6 rounded-2xl shadow-md border-t-4 border-amber-500">
          ...
          <h4 className="font-bold text-slate-800 mb-2">Recent Past</h4>
          <p className="text-sm text-slate-600 mb-3">Happened a short time ago and has a result now.</p>
          <p className="text-sm font-medium text-amber-700">"I <strong>have lost</strong> my keys." (I can't enter now)</p>
        </div>
      </div>
      ...
      <section className="bg-white rounded-2xl shadow-md overflow-hidden">
        <div className="bg-slate-900 text-white p-4">
          <h3 className="font-bold flex items-center gap-2">Signal Words</h3>
        </div>
          ...
          <table className="w-full text-left text-sm">
            <thead className="bg-slate-50 text-slate-500">
              <tr>
                ...
                <th className="p-4">Meaning / Usage</th>
      ...
      <div className="bg-indigo-50 rounded-2xl p-8 border border-indigo-100">
        <h3 className="text-xl font-bold text-indigo-900 mb-6 text-center">The Battle of Time: FOR vs SINCE</h3>
        <div className="grid md:grid-cols-2 gap-8">
          <div className="bg-white p-6 rounded-xl shadow-sm relative">
            ...
            <p className="text-slate-600 mb-4 mt-2">Used for <strong>DURATION</strong> (A period of time).</p>
          ...
          <div className="bg-white p-6 rounded-xl shadow-sm relative">
            ...
            <p className="text-slate-600 mb-4 mt-2">Used for <strong>STARTING POINT</strong> (When it began).</p>
            <ul className="space-y-2 text-sm text-slate-700">
      ...
      <section className="bg-slate-800 text-slate-300 rounded-2xl p-6 md:p-8 shadow-xl">
        ...
        <p className="mb-6">The main difference is the <strong>TIME</strong>.</p>

        <div className="grid md:grid-cols-2 gap-6">
          <div className="border border-slate-600 rounded-xl p-5">
            <h4 className="text-rose-400 font-bold mb-2">Simple Past</h4>
            <p className="text-sm mb-3">Time is finished. We know when it happened.</p>
          ...
          <div className="border border-slate-600 rounded-xl p-5">
            ...
            <p className="text-sm mb-3">Time doesn't matter or hasn't finished yet.</p>
            <ul className="text-sm space-y-2">
              <li className="flex justify-between">
