  ...
  return (
    <div className="space-y-8 pb-12">
      <header>
        ...
        <p className="text-slate-600">Understand the difference between what we can count and what we measure in mass.</p>
      </header>
        ...
        <div className="bg-white p-6 rounded-2xl shadow-md relative overflow-hidden">
          ...
          <div className="relative z-10">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h3 className="text-xl font-bold text-slate-800">Countable</h3>
            </div>
            <p className="text-slate-600 mb-4 text-sm leading-relaxed">
              Nouns that can be separated into individual units. They accept numbers and have plural forms.
            </p>
        ...
        <div className="bg-white p-6 rounded-2xl shadow-md relative overflow-hidden">
          ...
          <div className="relative z-10">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h3 className="text-xl font-bold text-slate-800">Uncountable</h3>
            </div>
            <p className="text-slate-600 mb-4 text-sm leading-relaxed">
              Abstract concepts, liquids, powders, or materials. We do not use numbers (1, 2, 3) directly with them.
            </p>
            <div className="bg-red-50 rounded-xl p-4 text-sm space-y-2 text-red-900 font-medium">
              ...
              <div className="mt-2 text-xs opacity-75 border-t border-red-200/50 pt-2">
                Examples: Money, Information, Advice, Furniture, Bread, Cheese.
              </div>
            </div>
          </div>
        </div>
            ...
            <tbody className="divide-y divide-slate-50">
              ...
              <tr className="hover:bg-slate-50/50">
                ...
                <td className="p-4">
                  ...
                  <div className="text-xs text-slate-400 mt-1">"Some few"</div>
                </td>
                <td className="p-4">
                  <span className="text-red-600 font-bold bg-red-50 px-2 py-1 rounded">A little</span>
                  <div className="text-xs text-slate-400 mt-1">"A little bit"</div>
                </td>
              </tr>
              <tr className="hover:bg-slate-50/50">
                <td className="p-4 font-semibold text-slate-700">Undefined (?)</td>
      ...
      <div className="grid lg:grid-cols-2 gap-8">
        ...
        <section className="bg-indigo-50 rounded-2xl p-6 shadow-sm">
          <h3 className="text-lg font-bold text-indigo-900 mb-4 flex items-center gap-2">
            <Package size={20} /> Making Uncountable &rarr; Countable
          </h3>
          <p className="text-sm text-indigo-800 mb-4">
            We use "Partitives" (containers or measurements) to count uncountable nouns.
          </p>
        ...
        <section className="bg-amber-50 rounded-2xl p-6 shadow-sm">
          <h3 className="text-lg font-bold text-amber-900 mb-4 flex items-center gap-2">
            <Coffee size={20} /> Watch Out: Context Changes Everything!
          </h3>
          <p className="text-sm text-amber-800 mb-4">
            Some words can be both types, depending on the meaning.
          </p>
          ...
          <div className="space-y-4">
            <div className="bg-white p-4 rounded-xl border-l-4 border-amber-400 shadow-sm">
              ...
              <div className="text-sm space-y-1">
                <p>💆‍♀️ <span className="text-red-600 font-bold">Uncountable:</span> "She has long hair." (All of it)</p>
                <p>🔍 <span className="text-emerald-600 font-bold">Countable:</span> "There is <span className="underline">a hair</span> in my soup!" (One strand)</p>
              </div>
            </div>
            ...
            <div className="bg-white p-4 rounded-xl border-l-4 border-amber-400 shadow-sm">
              ...
              <div className="text-sm space-y-1">
                <p>☕ <span className="text-red-600 font-bold">Uncountable:</span> "I love coffee." (The liquid in general)</p>
                <p>🛒 <span className="text-emerald-600 font-bold">Countable:</span> "Two coffees, please." (Two cups)</p>
              </div>
            </div>
          </div>
        </section>
